;(function (window) {
  ...
  let texts = ['Dear Chị Yêu', 'em biết đợt này chị đang stress', 'em rất xin lỗi',' vì em không tâm sự được với chị','còn 2 ngày nữa là đến ngày thi', 'em mong chị sẽ cố gắng vượt qua','thi tốt kì thi sắp tới','nó sẽ là 1 bước tiến lớn đối với chị','bởi vậy','có áp lực quá','thì cũng phải nhớ giữ sức khỏe nhá', 'cố gắng vượt qua giai đoạn này', 'chúc chị yêu thi tốt', 'Good luck']
